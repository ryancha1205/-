class ReservationsController < ApplicationController
  ...
  def new
    ...
    @price_per_day = params[:reservation][:price_per_day]
 ...
 def index
  ...
  def create
    ...
    if current_user == @listing.user
      #選択されてた日付 ","で区切って配列化
      p params[:selectedDates]
      selectedDates = params[:reservation][:selectedDates]
  ...
  private
    def reservation_params
      params.require(:reservation).permit(:start_date, :end_date, :price_per_day, :total_price, :listing_id)
    end
